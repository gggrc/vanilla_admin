 ...
 * Query params: search (optional) - search by name or NIM
 */
const getAllStudents = async (req, res) => {
  try {
    ...
    // Search by name or NIM if provided
    if (search) {
...
/**
 * Get Student Detail with Attendance
...
const getStudentDetail = async (req, res) => {
  try {
    ...
    // 2. Get enrollments with courses
    ...
    // 3. Get attendance for each enrollment
    ...
    // 4. Calculate tolerance status
    // Tolerance limit: 3 (late + absent should not exceed 3)
